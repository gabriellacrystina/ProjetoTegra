...
public class ProdutoDAO {
	...
	static{
		...
		adicionaProduto(new Produto("Expressões Regulares - Uma Abordagem Divertida", "Aurelio Marinho Jargas",20.00 ,13 ));
		...
		adicionaProduto(new Produto("Algoritmos: Teoria e Prática", "Thomas H. Cormen", 4.60, 1));
	}
